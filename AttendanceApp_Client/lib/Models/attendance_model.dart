...
class AttendanceResponseModel {
  ...
  factory AttendanceResponseModel.fromJson(Map<String, dynamic> json){
    return AttendanceResponseModel(
        ...
        trainingDateModel: json["trainingDateModel"] == null ? null : TrainingDateResponseModel.fromJson(Map<String, dynamic>.from(json["trainingDateModel"])),
...
class AttendanceRequestModel {
  ...
  final TrainingDateRequestModel? trainingDateModel = TrainingDateRequestModel();
