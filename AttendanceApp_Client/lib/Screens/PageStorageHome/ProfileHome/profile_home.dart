                            ...
                            Padding(
                                ...
                                child: Column(children: [
                                  FutureBuilder<ContractResponseModel?>(
                                    future: getContractByUserId(int.parse(token[
                                        "UserID"])), // Replace with your Future function
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        showDialog(
                                            context: context,
                                            builder: (context) {
                                              controller.changePasswordEmail
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  floatingLabelStyle:
                                                                      MaterialStateTextStyle.resolveWith(
                                                                          (Set<MaterialState>
                                                                              states) {
                                                                    final Color color = states.contains(MaterialState
                                                                            .error)
                                                                        ? Theme.of(context)
                                                                            .colorScheme
                                                                            .error
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    if (formKey1
                                                                      ...
                                                                      var dateProviderLogin =
                                                                          await userProvider
                                                                              .changePassword(controller.changePasswordRequestModel);
