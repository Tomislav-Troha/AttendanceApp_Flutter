...
('Maintenance', 'Ensures all facilities are clean, equipment is in working condition, and manages repair tasks.'),
('Receptionist', 'Manages member check-ins, handles inquiries, books classes, and provides overall member support.');
